...
#define _snd_mbf __kernel_snd_mbf
#define _psnd_mbf __kernel_psnd_mbf
#define _tsnd_mbf __kernel_tsnd_mbf
#define _rcv_mbf __kernel_rcv_mbf
#define _prcv_mbf __kernel_prcv_mbf
#define _trcv_mbf __kernel_trcv_mbf
...
#define _ini_mbf __kernel_ini_mbf
...
#define _ref_mbf __kernel_ref_mbf
