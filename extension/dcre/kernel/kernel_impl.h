 ...
 *  の責任を負わない．
 * 
 *  $Id: kernel_impl.h 999 2014-04-20 00:15:27Z ertl-hiro $
 */
...
#define default_acptn(domid)										\
				((domid) == TDOM_SELF ? rundom						\
				: (domid) == TDOM_KERNEL ? TACP_KERNEL				\
				: (domid) == TDOM_NONE ? TACP_SHARED : TACP(domid))
