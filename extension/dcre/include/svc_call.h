...
extern ER _kernel_def_tex(ID tskid, const T_DTEX *pk_dtex) throw();
...
#define def_tex _kernel_def_tex
...
#define _acre_tsk __kernel_acre_tsk
#define _acre_sem __kernel_acre_sem
#define _acre_flg __kernel_acre_flg
#define _acre_dtq __kernel_acre_dtq
#define _acre_pdq __kernel_acre_pdq
#define _acre_mtx __kernel_acre_mtx
#define _acre_mpf __kernel_acre_mpf
#define _acre_cyc __kernel_acre_cyc
#define _acre_alm __kernel_acre_alm
#define _acre_isr __kernel_acre_isr
#define _del_tsk __kernel_del_tsk
#define _del_sem __kernel_del_sem
#define _del_flg __kernel_del_flg
#define _del_dtq __kernel_del_dtq
#define _del_pdq __kernel_del_pdq
#define _del_mtx __kernel_del_mtx
#define _del_mpf __kernel_del_mpf
#define _del_cyc __kernel_del_cyc
#define _del_alm __kernel_del_alm
#define _del_isr __kernel_del_isr
#define _sac_tsk __kernel_sac_tsk
#define _sac_sem __kernel_sac_sem
#define _sac_flg __kernel_sac_flg
#define _sac_dtq __kernel_sac_dtq
#define _sac_pdq __kernel_sac_pdq
#define _sac_mtx __kernel_sac_mtx
#define _sac_mpf __kernel_sac_mpf
#define _sac_cyc __kernel_sac_cyc
#define _sac_alm __kernel_sac_alm
#define _sac_isr __kernel_sac_isr
#define _def_tex __kernel_def_tex
