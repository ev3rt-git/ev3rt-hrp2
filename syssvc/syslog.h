...
extern ER		_syslog_fwri_log(ER ercd, const SYSLOG *p_syslog,
														ID cdmid) throw();
extern ER_UINT	_syslog_rea_log(SYSLOG *p_syslog, ID cdmid) throw();
extern ER		_syslog_msk_log(uint_t logmask, uint_t lowmask,
														ID cdmid) throw();
extern ER		_syslog_ref_log(T_SYSLOG_RLOG *pk_rlog, ID cdmid) throw();

#ifdef TOPPERS_SVC_CALL

#define syslog_wri_log(prio, p_syslog) \
							_syslog_wri_log(prio, p_syslog, TDOM_KERNEL)
#define syslog_fwri_log(ercd, p_syslog) \
							_syslog_fwri_log(ercd, p_syslog, TDOM_KERNEL)
#define syslog_rea_log(p_syslog)	_syslog_rea_log(p_syslog, TDOM_KERNEL)
#define syslog_msk_log(logmask, lowmask) \
							_syslog_msk_log(logmask, lowmask, TDOM_KERNEL)
#define syslog_ref_log(pk_rlog)		_syslog_ref_log(pk_rlog, TDOM_KERNEL)
